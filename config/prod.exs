...
# BizzerWeb.Endpoint.init/2 when load_from_system_env is
...
config :bizzer, BizzerWeb.Endpoint,
  ...
  url: [host: "bizzer.store", port: 80],
  static_url: [host: "static.bizzer.store", port: 443, scheme: "https"],
...
# start per endpoint:
#
#     config :bizzer, BizzerWeb.Endpoint, server: true
#
